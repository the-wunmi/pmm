...
// Validate checks the field values on XtrabackupMetadata with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *XtrabackupMetadata) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on XtrabackupMetadata with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// XtrabackupMetadataMultiError, or nil if none found.
func (m *XtrabackupMetadata) ValidateAll() error {
	return m.validate(true)
}

func (m *XtrabackupMetadata) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	// no validation rules for ToLsn

	// no validation rules for FromLsn

	if len(errors) > 0 {
		return XtrabackupMetadataMultiError(errors)
	}

	return nil
}

// XtrabackupMetadataMultiError is an error wrapping multiple validation errors
// returned by XtrabackupMetadata.ValidateAll() if the designated constraints
// aren't met.
type XtrabackupMetadataMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m XtrabackupMetadataMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m XtrabackupMetadataMultiError) AllErrors() []error { return m }

// XtrabackupMetadataValidationError is the validation error returned by
// XtrabackupMetadata.Validate if the designated constraints aren't met.
type XtrabackupMetadataValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e XtrabackupMetadataValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e XtrabackupMetadataValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e XtrabackupMetadataValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e XtrabackupMetadataValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e XtrabackupMetadataValidationError) ErrorName() string {
	return "XtrabackupMetadataValidationError"
}

// Error satisfies the builtin error interface
func (e XtrabackupMetadataValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sXtrabackupMetadata.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause,
...
var _ error = XtrabackupMetadataValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = XtrabackupMetadataValidationError{}
...
func (m *Metadata) validate(all bool) error {
	...
	case *Metadata_XtrabackupMetadata:
		if v == nil {
			err := MetadataValidationError{
				field:  "BackupToolMetadata",
				reason: "oneof value cannot be a typed-nil",
		...
		if all {
			switch v := interface{}(m.GetXtrabackupMetadata()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, MetadataValidationError{
						field:  "XtrabackupMetadata",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetXtrabackupMetadata()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return MetadataValidationError{
					field:  "XtrabackupMetadata",
					reason: "embedded message failed validation",
