...
var (
	...
	file_backup_v1_common_proto_goTypes   = []any{
		...
		(*XtrabackupMetadata)(nil),    // 5: backup.v1.XtrabackupMetadata
		(*Metadata)(nil),              // 6: backup.v1.Metadata
		(*LogChunk)(nil),              // 7: backup.v1.LogChunk
		(*timestamppb.Timestamp)(nil), // 8: google.protobuf.Timestamp
	}
)
var file_backup_v1_common_proto_depIdxs = []int32{
	3, // 0: backup.v1.Metadata.file_list:type_name -> backup.v1.File
	8, // 1: backup.v1.Metadata.restore_to:type_name -> google.protobuf.Timestamp
	4, // 2: backup.v1.Metadata.pbm_metadata:type_name -> backup.v1.PbmMetadata
	5, // 3: backup.v1.Metadata.xtrabackup_metadata:type_name -> backup.v1.XtrabackupMetadata
